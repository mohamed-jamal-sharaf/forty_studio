// CODE Archive - Enhanced Monaco Editor with Professional Styling
            ...
            frappe.call({
                ...
                callback: (r) => {
                    if (r.message) {
                        ...
                        frappe.set_route('Form', 'Code Archive', r.message.name);
                    }
                }
            });
...
// ==================== MAIN FORM SCRIPT ====================
frappe.ui.form.on('Code Archive', {
    onload: function (frm) {
        console.log('CODE Archive: Form loading...');
        ...
        if (frm.fields_dict.code_editor) {
            ...
            console.log('CODE Archive: HTML created');
        }
    ...
    refresh: function (frm) {
        console.log('CODE Archive: Refresh');
...
console.log('✓ CODE Archive Enhanced Script Loaded v3.0.0 - Capital Project Premium Edition');